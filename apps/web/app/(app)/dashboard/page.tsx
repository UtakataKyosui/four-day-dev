...
import { analysis as analysisApi, meals as mealsApi, sleep as sleepApi } from "@/lib/api-client";
import type { HealthAnalysis, Meal, SleepRecord } from "@/lib/api-client";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-card rounded-lg border border-border p-4">
          <div className="flex justify-between items-center mb-3">
            ...
            <Link href="/meals" className="text-xs text-primary hover:underline">
              詳細
            </Link>
          </div>
        ...
        <div className="bg-card rounded-lg border border-border p-4">
          <div className="flex justify-between items-center mb-3">
            ...
            <Link href="/sleep" className="text-xs text-primary hover:underline">
              詳細
            </Link>
          </div>
          {todaySleep ? (
            <div className="space-y-1 text-sm">
              ...
              <p className="text-xs text-muted-foreground">
                {new Date(todaySleep.sleep_start).toLocaleTimeString("ja-JP", {
                  hour: "2-digit",
                  minute: "2-digit",
                })}{" "}
                〜{" "}
                {new Date(todaySleep.sleep_end).toLocaleTimeString("ja-JP", {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </p>
