...
impl Model {
    ...
    pub async fn create(
        ...
        let meal = ActiveModel {
            ...
            eaten_at: Set(params.eaten_at.with_timezone(&chrono::FixedOffset::east_opt(0).unwrap())),
    ...
    pub async fn update(
        ...
        if let Some(eaten_at) = params.eaten_at {
            active.eaten_at = Set(eaten_at.with_timezone(&chrono::FixedOffset::east_opt(0).unwrap()));
        }
